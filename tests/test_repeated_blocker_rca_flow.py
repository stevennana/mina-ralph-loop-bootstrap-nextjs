                ...
                "commands": [
                    {
                        ...
                        "ok": False,
                        "output": "FAIL tests/e2e/ui-forms.spec.ts\nFAIL tests/e2e/ui-system.spec.ts\n",
                        "error": "Snapshot mismatch tests/e2e/ui-owner-secondary.spec.ts-snapshots/mobile-tags.png\n",
                    }
                ],
                "missing_files": [],
            },
