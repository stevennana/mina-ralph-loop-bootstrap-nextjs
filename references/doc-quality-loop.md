...
- are the routes, surfaces, and user-visible behaviors specific enough to implement
...
- improve `ARCHITECTURE.md`, `docs/FRONTEND.md`, `docs/design-docs/*`, or `docs/product-specs/*` first
