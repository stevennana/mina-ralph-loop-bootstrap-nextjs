...
Before the first substantive product question, check whether relevant companion skills are installed and, if the user allows them, recommend installing missing ones before documentation starts and print the install commands immediately.
