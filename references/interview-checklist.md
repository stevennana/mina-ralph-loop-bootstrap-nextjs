...
- which UI-focused surfaces require screenshot, responsive, and accessibility proof before promotion
...
- explicit `@ui-*` Playwright coverage for UI-focused tasks when relevant
...
- what new user-visible capability is wanted next
...
- which current routes, screens, APIs, entities, or jobs change
...
- which end-to-end flows must be added or revised
- which external-resource flows need end-to-end proof before promotion
- which UI-focused surfaces need screenshot, responsive, and accessibility proof before promotion
- which deterministic commands must pass before the new tasks can promote
- whether `npm run verify` or other gates need to expand for this wave
